...
class Branch
{
	...
	public function getBulkCount($branch, $rangeFrom, $rangeTo)
	{
		...
		$result = $this->client->GetBulkCount(
			$data
		)->GetBulkCountResult;
	...
	public function getBulkReceptions($bulkId, $fromRows)
	{
		...
		$result = $this->client->GetBulkReceptions(
			$data
	...
	public function getBulkStatus($bulkId)
	{
		...
		$result = $this->client->GetBulkStatus(
			$data
		)->GetBulkStatusResult;
	...
	public function getTodaySent()
	{
		...
		$result = $this->client->GetTodaySent(
			$data
		)->GetTodaySentResult;
	...
	public function getTotalSent()
	{
		...
		$result = $this->client->GetTotalSent(
			$data
		)->GetTotalSentResult;
